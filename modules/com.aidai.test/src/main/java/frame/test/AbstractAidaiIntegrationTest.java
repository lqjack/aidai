...
public abstract class AbstractAidaiIntegrationTest {
	...
	public static MavenArtifactProvisionOption mavenBundle(String groupId,String artifactId,String version){
		return CoreOptions.mavenBundle(groupId, artifactId, version);
	}
        ...
        throws FileNotFoundException
    {
        try
        {
            URL fileURL = AbstractAidaiIntegrationTest.class.getClassLoader().getResource( filePath );
            if( fileURL == null )
            {
