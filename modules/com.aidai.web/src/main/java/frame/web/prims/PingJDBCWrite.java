...
/**
 * PingJDBCReadPrepStmt uses a prepared statement for database update. Statement parameters are set
 * dynamically on each request. This primative uses
 * {@link org.apache.aries.samples.ariestrader.direct.TradeJEEDirect} to set the price of a random
 * stock (generated by {@link org.apache.aries.samples.ariestrader.Trade_Config}) through the use of
 * prepared statements.
 */
public class PingJDBCWrite extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			// TradeJdbc via TradeServices makes use of prepared statements so I am going to reuse
			// the existing code.
