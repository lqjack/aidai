...
/**
 * PingServlet2Include tests servlet to servlet request dispatching. Servlet 1, the controller,
 * creates a new JavaBean object forwards the servlet request with the JavaBean added to Servlet 2.
 * Servlet 2 obtains access to the JavaBean through the Servlet request object and provides the
 * dynamic HTML output based on the JavaBean data. PingServlet2Servlet is the initial servlet that
 * sends a request to {@link PingServlet2ServletRcv}
 */
