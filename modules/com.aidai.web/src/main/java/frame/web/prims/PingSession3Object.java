...
public class PingSession3Object implements Serializable {
	...
	// Each instantiation of this class is approximately 1K in size (not including overhead for
	// arrays and Strings)
	...
	// The Session blob must be filled with data to avoid compression of the blob during
	// serialization
	PingSession3Object() {
		int index;
		byte b = 0x8;
	...
	/**
	 * Main method to test the serialization of the Session Data blob object Creation date:
	 * (4/3/2000 3:07:34 PM)
	 * @param args java.lang.String[]
	 */
	/**
	 * Since the following main method were written for testing purpose, we comment them out public
	 * static void main(String[] args) { try { PingSession3Object data = new PingSession3Object();
	 * FileOutputStream ostream = new FileOutputStream("c:\\temp\\datablob.xxx"); ObjectOutputStream
	 * p = new ObjectOutputStream(ostream); p.writeObject(data); p.flush(); ostream.close(); } catch
