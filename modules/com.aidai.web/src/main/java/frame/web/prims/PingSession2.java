...
/**
 * PingHTTPSession2 session create/destroy further extends the previous test by invalidating the
 * HTTP Session on every 5th user access. This results in testing HTTPSession create and destroy
 */
