...
/**
 * TradeAppServlet provides the standard web interface to Trade and can be accessed with the Go
 * Trade! link. Driving benchmark load using this interface requires a sophisticated web load
 * generator that is capable of filling HTML forms and posting dynamic data.
 */
